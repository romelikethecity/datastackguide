...
NEW_USE_CASES = [
    ...
    },
    {
        ...
        "recommended_tools": [
            ...
            {"slug": "census-data", "name": "Census", "why": "The leading reverse ETL tool. Pushes data from your warehouse back to operational tools: enriched segments to HubSpot, lead scores to Salesforce, usage metrics to Intercom. Essential for activating warehouse data in the tools your team uses."},
